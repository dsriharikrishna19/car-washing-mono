...
export const onboard = catchAsync(async (req: AuthRequest, res: Response) => {
...
export const updateStatus = catchAsync(async (req: AuthRequest, res: Response) => {
    const partner = await partnerService.updatePartnerStatus(req.params.partnerId as string, req.body.status);
    res.send(partner);
});

export const getAllPartners = catchAsync(async (req: AuthRequest, res: Response) => {
